...
# data
english data: CBT bench
arabic data: data/shifaa-train.csv
use questions only from here. and ask them to the dpo english model and the
base variant. 

# metrics
We would like to migrate to a 4 principle framework derived from our CBT cognitive distortion ablation skills

OBSELETE: use same metrics as these papers. the easiest ones to implement to judge quality of cbt response generated 
...
# Experiments
## ex 1
Implemnt vanilla dpo on the data we have.
