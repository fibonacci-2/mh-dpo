...
# responses, evaluated on the mentalqa dataset?
#
# Usage: ./run_exp_1.sh
...
QUESTIONS=data/sampled_questions_mentalqa.csv
GEN_BASE=results/gen_base_mentalqa.csv
GEN_DPO=results/gen_dpo_mentalqa.csv
JUDGE_PAIRWISE=results/judge_pairwise_mentalqa.csv
JUDGE_ABSOLUTE=results/judge_absolute_mentalqa.csv
SUMMARY=results/summary_mentalqa.md
...
python3 src/judge.py --a-file "$GEN_BASE" --a-name base --b-file "$GEN_DPO" --b-name dpo \
